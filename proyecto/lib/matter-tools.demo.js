...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 * Creates a new proyecto instance.
	...
	Demo.create = function (options) {
	  ...
	  if (demo.inline) {
	    demo.dom.root.classList.add('matter-proyecto-inline');
	  }
	...
	/**
	 * Starts a new proyecto instance by running the first or given example.
	 * See example for options and usage.
	 * @function Demo.start
	 * @param {proyecto} demo
	...
	/**
	 * Stops the currently running example in the proyecto.
	...
	Demo._createDom = function (options) {
	  ...
	  ToolsCommon.injectStyles(styles, 'matter-proyecto-style');
